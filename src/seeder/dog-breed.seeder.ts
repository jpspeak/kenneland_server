...
const seedDogBreed = async () => {
  ...
  const dogBreeds = dogBreedList.map(dogBreed => ({ name: dogBreed }));
  await DogBreed.insertMany(dogBreeds);
  console.log("Dog breed seeded.");
};

export default seedDogBreed;
